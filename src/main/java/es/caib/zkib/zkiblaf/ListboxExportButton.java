...
public class ListboxExportButton extends Button {
	/**
	 ...
	 * Versió 1.2: Alejandro Usero Ruiz 14-15/03/2011
	 * - Corregimos problema que aparece en IE cuando estamos sobre https, hacemos que
	 *   se redirija al servlet ContentExportServlet donde se pasan los parámetros 
	 *   adecuados.
	 * - Es sustitueix el salt de linia per espai (per defecte) - es controla per
	 *   la variable conservaSaltLinia (S/N)
	 *      
	 * Versió 1.3 - 29/02/2012
	...
	public ListboxExportButton() {
		setLabel(Messages.getString("ListboxExportButton.ExportResults")); //$NON-NLS-1$
